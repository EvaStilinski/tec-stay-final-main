...
if __name__ == '__main__':
    ...
    for counter_most_common in range(5, max_word_count, increment_step):  
        ...
        print(f"Counter Most Common: {counter_most_common}, Prediction Accuracy: {accuracy*100:.2f}%")       
         # Store the results
        counter_values.append(counter_most_common)
    ...
    plt.plot(counter_values, accuracies, marker='o')
    plt.title('Emotion Classification Accuracy vs Lexicon Size')
    plt.xlabel('Lexicon Size (Most Common Words)')
